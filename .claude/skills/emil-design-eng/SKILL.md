...
description: This skill encodes Emil Kowalski's philosophy on UI polish, component design, animation decisions, and the invisible details that make software feel great. Use when polishing a component, deciding whether a small detail is worth the code it costs, or judging whether an interaction feels finished rather than merely working.
---

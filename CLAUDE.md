...
| `.agents/rules/97-ad-copy.md` | Ad copy — why no line counts what the bank holds, why a drawing is a diagram and never a "plate", and the student's voice the owner rewrote all twenty-six scripts into |
...
| `.agents/rules/97-video-ads.md` | The ad pipeline — what it produces, why a cut made in an agent sandbox is never shippable, and the five rules a re-cut has already paid for |

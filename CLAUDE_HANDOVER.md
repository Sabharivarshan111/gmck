...
## 23. 🩺 Examination-Grade General Medicine Proforma Suite & Release v23
- **Bedside Proforma Overhaul (`clinicalProformas.ts`)**: Rewrote and expanded from 1,473 to 3,267 lines (+2,440 insertions), strictly transcribing all 4 definitive clinical examination PDFs (CVS, RS, Abdomen, CNS) from Google Drive:
  - **Cardiovascular System (CVS)**: Exhaustive HPI, negative history (RHF, LHF, RF, CHD, PHT), facies, IE stigmata, all 10 pulse parameters, 4-limb BP & postural drop, detailed JVP waveform breakdown ('a', 'c', 'x', 'v', 'y', cannon 'a', Kussmaul), all 12 peripheral signs of severe Aortic Regurgitation (Hill, Lighthouse, Locomotor brachii, Collapsing, Pulsus bisferiens, Landolfi, Müller, Quincke, Duroziez, Traube, Becker, Gerhardt/Sailer), precordial inspection/palpation/percussion, dynamic auscultation maneuvers (MDM in left lateral decubitus with bell in held expiratory apnea, PSM radiating to axilla, EDM sitting forward in held expiratory apnea, Carvallo sign for TR), and 5-part presentation diagnosis rubric.
  - **Respiratory System (RS)**: Cough, sputum (3-layered in bronchiectasis, rusty in pneumonia), dyspnea (mMRC 0-4), hemoptysis (MS pulmonary apoplexy), pneumonia aspiration risks (ABCDEF mnemonic), childhood infections, sympathetic effusion abdominal triggers, clubbing (grades 1-4, Schamroth, Lovibond; rule: absent in COPD alone), Horner syndrome, Hoover sign, Trail sign, Campbell sign, tape chest expansion (>= 5 cm), bilateral 9-region comparative percussion (+/-), Traube space, tidal percussion, auscultation across all 9 regions (vesicular, bronchial: tubular/cavernous/amphoric, added sounds, vocal resonance, egophony E-to-A, succussion splash, coin percussion test), and diagnosis formulation rubric.
  - **Abdomen & Hepatobiliary**: SOCRATES abdominal pain, distension (6 Fs), viral hepatitis risk factors & vaccines, complete head-to-toe stigmata of chronic liver disease & portal HT (temporal wasting, KF ring, parotid enlargement, fetor hepaticus, spider angiomas in SVC territory, gynecomastia, asterixis, palmar erythema, Dupuytren, Terry nails, Muehrcke lines, caput medusae, testicular atrophy, Spider-man habitus), supine/head-rising/standing inspection, two-finger milking test for venous direction (portal HT vs. IVC obstruction), liver span in MCL, spleen palpation from RIF with Hackett grading (0-5) and Middleton maneuver, bimanual kidney ballottement, ascites (fluid thrill > 1500 mL, shifting dullness > 500 mL, puddle sign ~ 100 mL), Cruveilhier-Baumgarten venous hum, arterial bruits, Child-Turcotte-Pugh scoring (PABAE Class A, B, C), and presentation diagnosis rubric.
  - **Central Nervous System (CNS) — Post-Graduate (M.D.) Grade**: Handedness & hemisphere dominance, motor weakness functional task analysis (upper limb proximal combing hair vs. distal buttoning/writing; lower limb proximal squatting vs. distal slipping chappals/tripping toes; neck flexion vs. extension; Beevor sign; single breath count < 20), spinomotor symptoms & ABCDEFM involuntary movements, sensory positive vs. negative symptoms, Folstein 30-point MMSE rubric, complete Cranial Nerves I to XII bilateral testing protocol, circumferential tape measurements from fixed bony landmarks, tone analysis, MRC Grade 0-5 power, complete superficial reflexes, deep tendon reflexes with inverted supinator sign and pendular knee jerk, primitive/frontal release reflexes (glabellar tap, palmomental, snout, grasp, Hoffmann), cerebellar VANISHED signs, gait patterns, sensory modalities (spinothalamic, posterior column, cortical), meningeal irritation signs, peripheral nerve thickening, and dual-tier master diagnostic formulation (anatomical localization + pathological diagnosis).
- **Tooling & Media Fixes**:
  - `mobile/src/components/PdfViewerModal.tsx`: Explicit aspect-ratio bounds, background canvas stabilization, page zoom/pinch navigation.

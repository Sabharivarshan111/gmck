...
export const LAB_VALUES: LabSection[] = [
  {
    ...
    values: [
      {
        name: 'Haemoglobin',
        conventional: 'M 13–17 g/dL · F 12–15 g/dL',
        si: 'M 130–170 g/L · F 120–150 g/L',
        variants: [
          { label: 'Newborn', value: '14–24 g/dL' },
          { label: 'Infant 3–6 months', value: '9.5–14 g/dL' },
          { label: 'Child 1–6 years', value: '11–14 g/dL' },
          { label: 'Pregnancy', value: '≥ 11 g/dL (WHO); anaemia below that' },
        ],
        critical: 'Below 7 g/dL — transfusion threshold in a stable patient',
        note: 'WHO anaemia cut-offs: 13 in men, 12 in non-pregnant women, 11 in pregnancy and in children 6–59 months.',
      },
      {
      ...
      },
      {
        ...
        conventional: 'N 40–75% · L 20–45% · E 1–6% · M 2–10% · B 0–1%',
      ...
      },
      {
        ...
        conventional: 'M 40–50% · F 36–46%',
        note: 'Roughly three times the haemoglobin in g/dL. A gross mismatch means a sampling or analyser error.',
      },
      { name: 'MCV', conventional: '80–100 fL', note: 'The first fork in the anaemia workup: microcytic, normocytic or macrocytic.' },
      { name: 'MCH', conventional: '27–32 pg' },
      { name: 'MCHC', conventional: '32–36 g/dL' },
      { name: 'RDW', conventional: '11.5–14.5%', note: 'Raised in iron deficiency, usually normal in thalassaemia trait.' },
      {
      ...
      {
        name: 'ESR (Westergren)',
        conventional: 'M 0–15 mm/hr · F 0–20 mm/hr',
        note: 'Rises with age — a rough ceiling is age divided by 2 in men, and (age + 10) divided by 2 in women.',
      },
      { name: 'Prothrombin time', conventional: '11–13.5 s · INR 0.8–1.2', critical: 'INR above 5 on warfarin — reversal' },
      { name: 'aPTT', conventional: '25–35 s' },
      { name: 'Bleeding time (Ivy)', conventional: '2–7 min' },
      { name: 'Clotting time', conventional: '4–9 min' },
      { name: 'D-dimer', conventional: 'Below 500 ng/mL FEU', note: 'Useful to EXCLUDE thromboembolism in a low-probability patient; a positive result proves nothing on its own.' },
      { name: 'Fibrinogen', conventional: '200–400 mg/dL' },
      { name: 'Serum ferritin', conventional: 'M 30–300 ng/mL · F 15–200 ng/mL', note: 'An ACUTE PHASE REACTANT — it can be normal or high in iron deficiency with coexisting inflammation. Below 15 is diagnostic; below 30 is deficiency in practice.' },
      { name: 'Serum iron', conventional: '60–170 µg/dL' },
      { name: 'TIBC', conventional: '240–450 µg/dL', note: 'HIGH in iron deficiency, LOW in anaemia of chronic disease — which is how the two are separated.' },
      ...
      { name: 'HbA1c', conventional: 'Below 5.7% normal · 5.7–6.4% prediabetes · ≥ 6.5% diabetes', note: 'Reflects 8–12 weeks. Unreliable in haemolysis, recent transfusion, haemoglobinopathy and chronic kidney disease.' },
    ],
  },
  {
    ...
    values: [
      ...
      { name: 'Blood urea nitrogen (BUN)', conventional: '7–20 mg/dL', note: 'Urea divided by 2.14. A BUN:creatinine ratio above 20 suggests a prerenal cause or an upper GI bleed.' },
      {
        name: 'Serum creatinine',
        conventional: 'M 0.7–1.3 mg/dL · F 0.6–1.1 mg/dL',
        si: 'M 62–115 µmol/L · F 53–97 µmol/L',
        note: 'A poor early marker: it does not rise until roughly half the GFR is lost, and it is lower in the elderly and the malnourished because it depends on muscle mass.',
      },
      {
        name: 'eGFR (CKD-EPI)',
      ...
      },
      {
        ...
        critical: 'Below 2.5 or above 6.5 mEq/L — ECG and treat now',
      ...
      { name: 'Anion gap', conventional: '8–12 mEq/L', note: 'Na − (Cl + HCO₃). Raised in MUDPILES; corrected for albumin, since a low albumin lowers the measured gap.' },
      ...
      { name: 'Serum uric acid', conventional: 'M 3.5–7.2 mg/dL · F 2.6–6.0 mg/dL' },
      { name: 'Serum osmolality', conventional: '275–295 mOsm/kg', note: '2×Na + glucose/18 + urea/2.8. An osmolar gap above 10 suggests an unmeasured osmole — methanol, ethylene glycol, ethanol.' },
    ],
  },
  {
    group: 'Liver',
    values: [
      ...
      { name: 'AST (SGOT)', conventional: '5–40 U/L', note: 'AST:ALT above 2 with both under 300 suggests alcoholic liver disease.' },
      { name: 'ALT (SGPT)', conventional: '7–56 U/L', note: 'More liver-specific than AST. Values in the thousands mean viral hepatitis, ischaemia or a toxin.' },
      { name: 'Alkaline phosphatase', conventional: '40–130 U/L', variants: [{ label: 'Child / adolescent', value: 'Up to 3× the adult upper limit — growing bone' }], note: 'Raised out of proportion to the transaminases in obstruction. Confirm the liver origin with GGT, since bone raises it too.' },
      { name: 'GGT', conventional: 'M 10–50 U/L · F 8–40 U/L' },
      ...
      { name: 'Total protein', conventional: '6.0–8.3 g/dL', note: 'A:G ratio normally 1.2–2.0 — REVERSED in chronic liver disease and in myeloma.' },
      { name: 'Prothrombin time / INR', conventional: 'INR 0.8–1.2', note: 'The BEST marker of acute synthetic function — factor VII has a half-life of 6 hours. In obstructive jaundice it corrects with parenteral vitamin K; in hepatocellular failure it does not.' },
      ...
      { name: 'Alpha-fetoprotein', conventional: 'Below 10 ng/mL', note: 'HCC surveillance in cirrhosis, with 6-monthly ultrasound.' },
    ],
  },
  {
    group: 'Biochemistry',
    values: [
      ...
      { name: 'Postprandial (2 h) glucose', conventional: 'Below 140 normal · 140–199 IGT · ≥ 200 diabetes' },
      { name: 'Random plasma glucose', conventional: '≥ 200 mg/dL with symptoms is diagnostic of diabetes' },
      { name: 'GDM (DIPSI, India)', conventional: '75 g non-fasting, 2 h value ≥ 140 mg/dL is diagnostic', note: 'Single step, irrespective of the last meal — designed for women who travel long distances fasting.' },
      { name: 'Total cholesterol', conventional: 'Desirable below 200 mg/dL' },
      { name: 'LDL cholesterol', conventional: 'Optimal below 100 mg/dL', note: 'Below 70 with established cardiovascular disease.' },
      { name: 'HDL cholesterol', conventional: 'M above 40 · F above 50 mg/dL' },
  ...
  },
  {
    ...
    values: [
      { name: 'Troponin I / T (hs)', conventional: 'Assay-specific; below the 99th percentile', note: 'The RISE AND FALL matters more than a single value — repeat at 3 hours. Chronically raised in renal failure.' },
      { name: 'CK-MB', conventional: '0–5 ng/mL, or below 5% of total CK' },
      { name: 'NT-proBNP', conventional: 'Below 125 pg/mL rules out heart failure in a stable patient', note: 'Rises with age and renal impairment; lower in obesity.' },
      { name: 'C-reactive protein', conventional: 'Below 6 mg/L', note: 'Rises within hours and falls quickly — better than ESR for following a response to treatment.' },
      ...
      { name: 'ASO titre', conventional: 'Below 200 IU/mL' },
  ...
  },
  {
    group: 'Endocrine',
    values: [
      { name: 'TSH', conventional: '0.4–4.0 mIU/L', variants: [{ label: 'Pregnancy, 1st trimester', value: '0.1–2.5 mIU/L' }], note: 'The single best screening test — it moves before T4 does.' },
      { name: 'Free T4', conventional: '0.8–1.8 ng/dL' },
      { name: 'Free T3', conventional: '2.3–4.2 pg/mL' },
      { name: 'Serum cortisol (8 am)', conventional: '5–25 µg/dL' },
      { name: 'PTH (intact)', conventional: '15–65 pg/mL' },
      { name: 'Vitamin D (25-OH)', conventional: 'Sufficient above 30 ng/mL · 20–30 insufficient · below 20 deficient' },
      { name: 'Serum prolactin', conventional: 'M below 20 · F below 25 ng/mL' },
      { name: 'Beta-hCG', conventional: 'Non-pregnant below 5 mIU/mL', note: 'Doubles roughly every 48 h in a normal early intrauterine pregnancy; a slower rise suggests ectopic or failing pregnancy.' },
    ],
  },
  {
    ...
    values: [
      ...
      { name: 'PaO₂', conventional: '80–100 mmHg (room air)', critical: 'Below 60 mmHg — respiratory failure', note: 'Type I respiratory failure is a low PaO₂ with a normal or low PaCO₂; type II is a low PaO₂ with PaCO₂ above 50.' },
      { name: 'PaCO₂', conventional: '35–45 mmHg', critical: 'Above 50 mmHg with acidosis' },
      { name: 'HCO₃⁻', conventional: '22–26 mEq/L' },
      { name: 'Base excess', conventional: '−2 to +2 mEq/L' },
      { name: 'SaO₂', conventional: '95–100%' },
      { name: 'A–a gradient', conventional: 'Roughly (age/4) + 4 mmHg', note: 'A NORMAL gradient with hypoxia means hypoventilation or low inspired oxygen; a RAISED gradient means shunt, V/Q mismatch or diffusion defect.' },
    ],
  },
  {
    group: 'Urine',
    values: [
      ...
      { name: 'Urine microscopy', conventional: 'RBC 0–2/hpf · WBC 0–5/hpf · no casts', note: 'RED CELL CASTS mean glomerulonephritis. Fatty casts and oval fat bodies mean nephrotic syndrome.' },
      { name: 'Fractional excretion of sodium', conventional: 'Below 1% prerenal · above 2% intrinsic (ATN)', note: 'Invalid after a diuretic — use FEUrea instead.' },
    ],
  },
  {
    group: 'CSF and body fluids',
    values: [
      { name: 'CSF opening pressure', conventional: '6–20 cm H₂O' },
      { name: 'CSF cells', conventional: '0–5 lymphocytes/mm³', note: 'Neutrophils predominate in bacterial meningitis; lymphocytes in viral and tuberculous.' },
      { name: 'CSF protein', conventional: '15–45 mg/dL', note: 'Very high (100s) in tuberculous meningitis, with a cobweb coagulum on standing.' },
      { name: 'CSF glucose', conventional: '50–80 mg/dL, or above ⅔ of the plasma value', note: 'LOW in bacterial, tuberculous and fungal meningitis; NORMAL in viral.' },
      { name: 'Ascitic SAAG', conventional: '≥ 1.1 g/dL means portal hypertension · below 1.1 means it does not', note: 'Serum albumin minus ascitic albumin, samples the SAME day. Replaced the exudate–transudate split because cardiac ascites has a high SAAG AND a high protein.' },
      { name: 'Ascitic fluid neutrophils (SBP)', conventional: '≥ 250/mm³ is diagnostic of spontaneous bacterial peritonitis' },
      { name: 'Pleural fluid — Light criteria', conventional: 'Exudate if ANY: fluid:serum protein > 0.5, fluid:serum LDH > 0.6, or fluid LDH > ⅔ the serum upper limit' },
      { name: 'Pleural / ascitic ADA', conventional: 'Above 40 U/L supports tuberculosis' },
    ],
  },
  {
    ...
    values: [
      ...
      },
      {
        ...
        note: 'WHO fast breathing: ≥60 under 2 months, ≥50 at 2–12 months, ≥40 at 1–5 years.',
      },
      {
        name: 'Blood pressure',
      ...
      { name: 'SpO₂', conventional: '95–100%', critical: 'Below 90% — and a normal saturation never excludes airway obstruction' },
      { name: 'Glasgow Coma Scale', conventional: 'E4 V5 M6 = 15; minimum 3', critical: '8 or below — intubate' },
      { name: 'Urine output (child)', conventional: '1–2 mL/kg/hr' },
      { name: 'BMI', conventional: 'Asian-Indian: normal 18.5–22.9 · overweight 23–24.9 · obese ≥ 25', note: 'The Indian cut-offs are LOWER than the WHO international ones, because cardiometabolic risk starts at a lower BMI in South Asians.' },
    ],
  },
];

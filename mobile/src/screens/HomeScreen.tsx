          ...
          sections={{
            ...
            */}
            ...
            <View
              ...
              /></> : <>
                <QuickAction icon={<BookOpen size={18} color={colors.primary} />} label="Bank" accessibilityLabel="Question bank" sub="Browse your syllabus" color={colors.primary} compact={scales.quick < 0.85} style={scales.quick < 0.75 ? { flex: 0, flexBasis: '48%' } : undefined} onPress={() => navigation.navigate('BrowseHome', {})} />

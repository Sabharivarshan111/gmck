...
export const drawItFromMemory: AdScript = {
  ...
  shots: [
    ...
    { n: 6, screen: 'questions', camera: 'push', text: 'Triple-tap', vo: 'Triple-tap the question and the plate comes with it.', focus: 0.3, accent: '#FF4D8D' },
    ...
    { n: 9, screen: 'chapterDiagrams', camera: 'pull', text: '250 plates', vo: 'Two hundred and fifty plates across the whole bank.' },
    ...
    { n: 22, screen: 'noteDiagram', camera: 'pull', text: 'Yours against the plate', vo: 'Compare yours against the plate. That is the drill.', accent: '#22D3A6' },

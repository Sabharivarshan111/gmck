...
export const reelAnki: AdScript = {
  ...
  shots: [
    ...
    { n: 6, frames: 129, screen: 'ankiStudy', mascot: 'guide', camera: 'macro', text: 'Cards, pictures and cloze', silentText: 'Your deck, beside your own', vo: 'Cards, pictures and cloze deletions all come through.', accent: '#7C5CFF' },
    { n: 7, frames: 129, screen: 'ankiStudy', camera: 'push', text: 'Two hundred new cards a day', silentText: '200 new cards a day', vo: 'Two hundred new cards a day, not fifty.', focus: 0.4, accent: '#F5B301' },

...
export const reelAttendance: AdScript = {
  ...
  shots: [
    ...
    { n: 5, frames: 130, screen: 'attendance', camera: 'push', text: 'No percentage maths in your head', silentText: 'See the number directly', vo: 'No percentage maths in your head.', focus: 0.42, accent: '#4CC2FF' },
    ...
    { n: 8, frames: 130, screen: 'attendanceCritical', camera: 'push', text: 'instead of rounding it for you', silentText: 'No rounding', vo: 'It keeps the calculation exact instead of rounding it for you.', focus: 0.62, accent: '#F5B301' },

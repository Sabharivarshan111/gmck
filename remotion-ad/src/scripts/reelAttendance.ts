...
export const reelAttendance: AdScript = {
  ...
  shots: [
    ...
    { n: 12, frames: 100, screen: 'attendancePostings', camera: 'macro', text: 'A posting has an end date', silentText: 'A posting has an end date', vo: 'A posting has an end date. Theory does not.', focus: 0.35, accent: '#FF4D8D' },
    { n: 13, frames: 100, screen: 'attendancePostings', camera: 'glideDown', text: 'How many days are actually left', silentText: 'It counts the days left', vo: 'So it counts how many days are actually left.', focus: 0.5, accent: '#FF4D8D' },

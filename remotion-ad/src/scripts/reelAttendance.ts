...
export const reelAttendance: AdScript = {
  ...
  shots: [
    ...
    { n: 2, frames: 125, screen: 'attendanceEmpty', mascot: 'guide', camera: 'push', text: 'Add them once', silentText: 'Add your subjects once', vo: 'Add your subjects once at the start.', accent: '#22D3A6' },
    { n: 3, frames: 130, screen: 'attendance', camera: 'macro', text: 'Present or absent', silentText: 'Tap present or absent', vo: 'After each class tap present or absent.', focus: 0.3, accent: '#22D3A6' },
    { n: 4, frames: 130, screen: 'attendance', camera: 'macro', text: 'Safely miss nine more', silentText: 'You can safely miss 9', vo: 'It tells you that you can safely miss nine more.', focus: 0.45, accent: '#22D3A6' },
    { n: 5, frames: 135, screen: 'attendance', camera: 'push', text: 'A number', silentText: 'A number, not a percentage', vo: 'A number rather than a percentage to work out.', focus: 0.42, accent: '#4CC2FF' },
    { n: 6, frames: 130, screen: 'attendanceCritical', camera: 'glideDown', text: 'Exactly on seventy-five', silentText: 'Exactly on 75%', vo: 'Sitting exactly on seventy-five per cent?', focus: 0.55, accent: '#4CC2FF' },
    { n: 7, frames: 130, screen: 'attendanceCritical', camera: 'macro', text: 'Not another one', silentText: 'You cannot miss another one', vo: 'Then it says you cannot miss another one.', focus: 0.62, accent: '#F5B301' },
    { n: 8, frames: 135, screen: 'attendanceCritical', camera: 'push', text: 'It never rounds up', silentText: 'It never rounds up', vo: 'It never rounds up. Rounding is how people fall short.', focus: 0.62, accent: '#F5B301' },
    { n: 9, frames: 130, screen: 'attendance', mascot: 'guide', camera: 'macro', text: 'Your college sets it', silentText: 'Your college sets the target', vo: 'Your college sets the target, not the app.', focus: 0.5, accent: '#F5B301' },

...
export const reelDrawIt: AdScript = {
  ...
  shots: [
    ...
    { n: 7, frames: 129, screen: 'chapterDiagrams', camera: 'glideDown', text: 'Two hundred and fifty diagrams', silentText: "250 exam diagrams", vo: 'Two hundred and fifty diagrams, drawn by hand.', accent: '#22D3A6' },

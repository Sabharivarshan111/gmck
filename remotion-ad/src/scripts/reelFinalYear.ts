...
export const reelFinalYear: AdScript = {
  ...
  shots: [
    { n: 1, frames: 129, screen: null, mascot: 'hero', camera: 'settle', text: 'Exam in six weeks', silentText: 'Ward now. Exam soon.', vo: 'Ward in the morning. Exam in six weeks.', accent: '#FF4D8D' },
    { n: 2, frames: 129, screen: 'browse', mascot: 'guide', camera: 'trackLeft', text: 'broken down by chapter', silentText: 'Every subject, every chapter', vo: 'Every subject in your year, broken down by chapter.', accent: '#FF4D8D' },
    { n: 3, frames: 129, screen: 'questionsChapters', camera: 'push', text: 'straight to what you need', silentText: 'Go straight to the chapter', vo: 'So you can go straight to what you need.', focus: 0.35, accent: '#4CC2FF' },
    { n: 4, frames: 129, screen: 'questionsLeaf', camera: 'macro', text: 'how often the question has been asked', silentText: 'See the repeat frequency', vo: 'And see how often the question has been asked.', focus: 0.28, accent: '#4CC2FF' },
    { n: 5, frames: 129, screen: 'askai', mascot: 'guide', camera: 'push', text: 'Ask it in normal language', silentText: 'Ask AI', vo: 'Stuck on one? Ask it in normal language.', accent: '#7C5CFF' },
    { n: 6, frames: 129, screen: 'askai', camera: 'macro', text: 'shaped around the exam question', silentText: 'Exam-focused answer', vo: 'Get an answer shaped around the exam question.', accent: '#7C5CFF' },
    { n: 7, frames: 129, screen: 'flashcards', camera: 'orbit', text: 'flashcards for the drive in', silentText: 'Flashcards for the commute', vo: 'Turn a chapter into flashcards for the drive in.', accent: '#4CC2FF' },
    { n: 8, frames: 129, screen: 'ankiStudy', camera: 'macro', text: 'the deck your batch already shares', silentText: 'Import your batch deck', vo: 'Or import the deck your batch already shares.', accent: '#4CC2FF' },
    { n: 9, frames: 128, screen: 'attendancePostings', mascot: 'guide', camera: 'push', text: 'so you can see what’s left', silentText: 'See your posting days left', vo: 'Postings have an end date, so you can see what’s left.', accent: '#22D3A6' },
    { n: 10, frames: 128, screen: 'attendancePostings', camera: 'macro', text: 'how many classes you can still miss', silentText: 'Check how many you can miss', vo: 'And check how many classes you can still miss.', focus: 0.4, accent: '#22D3A6' },

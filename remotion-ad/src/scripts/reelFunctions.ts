...
export const reelFunctions: AdScript = {
  ...
  shots: [
    ...
    { n: 7, beats: 6, screen: 'plateBrachial', camera: 'settle', kicker: 'Exam diagrams', text: '250 diagrams, every part labelled', accent: '#22D3A6' , silentText: '250 diagrams, every part labelled', vo: '250 diagrams, every part labelled.' },

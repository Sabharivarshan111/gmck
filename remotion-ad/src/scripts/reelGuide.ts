...
export const reelGuide: AdScript = {
  ...
  shots: [
    ...
    { n: 1, frames: 75, screen: null, mascot: 'hero', camera: 'settle', text: 'I live inside Orbit', silentText: "Meet your study guide", vo: 'I live inside Orbit.', accent: '#7C5CFF' },
    { n: 2, frames: 100, screen: 'browse', mascot: 'guide', camera: 'trackLeft', text: 'All four MBBS years', silentText: "All four MBBS years", vo: 'I know all four MBBS years.', accent: '#7C5CFF' },

    // --- the bank, and the thing about it nobody else has counted.
    { n: 3, frames: 105, screen: 'questionsChapters', camera: 'push', text: 'Five thousand six hundred questions', silentText: "5,634 questions, sorted", vo: 'Five thousand six hundred questions, all sorted.', focus: 0.35, accent: '#4CC2FF' },
    { n: 4, frames: 100, screen: 'questionsLeaf', camera: 'macro', text: 'Three thousand of them repeat', silentText: "3,463 have been asked before", vo: 'Over three thousand of them repeat.', focus: 0.28, accent: '#F5B301' },

    // --- the payload. Front-loaded, because it is the reason to install.
    { n: 5, frames: 100, screen: 'questionsLeaf', mascot: 'guide', camera: 'macro', text: 'Triple-tap any question', silentText: "Triple-tap any question", vo: 'Triple-tap any question and watch.', focus: 0.28, accent: '#FF4D8D' },
    { n: 6, frames: 110, screen: 'noteHero', camera: 'push', text: 'A full handwritten answer', silentText: "A full handwritten answer", vo: 'I write you a full handwritten answer.', accent: '#FF4D8D' },
    { n: 7, frames: 105, screen: 'noteBody', camera: 'glideDown', text: 'The way examiners read', silentText: "Laid out exam-shaped", vo: 'Laid out the way examiners read.', accent: '#FF4D8D' },
    ...
    { n: 11, frames: 105, screen: 'askai', mascot: 'guide', camera: 'push', text: 'Ask me anything', silentText: "Stuck? Ask the AI", vo: 'Still stuck? Ask me anything at all.', accent: '#7C5CFF' },
    { n: 12, frames: 95, screen: 'chatdemo', camera: 'macro', text: 'Ask for MCQs', silentText: "It writes you a quiz", vo: 'Ask for MCQs. I write them.', accent: '#7C5CFF' },

    // --- flashcards.
    { n: 13, frames: 100, screen: 'flashcards', mascot: 'guide', camera: 'orbit', text: 'Turn any chapter into flashcards', silentText: "Any chapter to flashcards", vo: 'Turn any chapter into flashcards.', accent: '#4CC2FF' },
    { n: 14, frames: 95, screen: 'ankiStudy', camera: 'macro', text: 'Before you forget', silentText: "They return before you forget", vo: 'They come back before you forget.', accent: '#4CC2FF' },

    // --- focus.
    { n: 15, frames: 105, screen: 'timer', mascot: 'guide', camera: 'push', text: 'A tree grows', silentText: "Focus, and a tree grows", vo: 'Start a session and a tree grows.', accent: '#22D3A6' },
    { n: 16, frames: 95, screen: 'treegallery', camera: 'trackRight', text: 'Twelve species', silentText: "Twelve species to unlock", vo: 'Twelve species, earned in focused hours.', accent: '#22D3A6' },
    { n: 17, frames: 95, screen: 'progress', camera: 'pull', text: 'Your streak needs no account', silentText: "Your streak needs no account", vo: 'Your streak needs no account.', accent: '#F5B301' },

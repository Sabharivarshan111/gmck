...
export const reelGuide: AdScript = {
  ...
  shots: [
    ...
    { n: 8, frames: 129, screen: 'chapterDiagrams', camera: 'glideDown', text: 'Two hundred and fifty diagrams', silentText: "250 exam diagrams", vo: 'Two hundred and fifty diagrams.', accent: '#22D3A6' },

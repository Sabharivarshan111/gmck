...
export const reelGuideAnswer: AdScript = {
  ...
  shots: [
    { n: 1, frames: 129, screen: null, mascot: 'hero', camera: 'settle', text: 'your brain is empty', silentText: 'Brain = blank', vo: 'You read the question and suddenly your brain is empty.', accent: '#7C5CFF' },
    ...
    { n: 3, frames: 129, screen: 'noteHero', mascot: 'guide', camera: 'push', text: 'The answer opens', silentText: 'Triple-tap for the answer', vo: 'Triple-tap it. The answer opens.', accent: '#FF4D8D' },
    { n: 4, frames: 129, screen: 'noteBody', camera: 'glideDown', text: 'the years it was asked', silentText: 'Headings. Points. Years.', vo: 'Headings, points and the years it was asked.', accent: '#FF4D8D' },
    { n: 5, frames: 129, screen: 'noteBodyBottom', camera: 'glideDown', text: 'the important points', silentText: 'Must-write points', vo: 'Then the important points at the end.', accent: '#FF4D8D' },
    { n: 6, frames: 129, screen: 'plateBrachial', mascot: 'guide', camera: 'settle', text: 'the diagram that belongs with it', silentText: 'The matching diagram', vo: 'And the diagram that belongs with it.', accent: '#22D3A6' },
    { n: 7, frames: 129, screen: 'askai', mascot: 'guide', camera: 'push', text: 'Ask again', silentText: 'Still stuck?', vo: 'Still confused? Ask again.', accent: '#7C5CFF' },
    { n: 8, frames: 129, screen: 'chatdemo', camera: 'macro', text: 'in your own words', silentText: 'Ask it your way', vo: 'You can ask it in your own words.', accent: '#7C5CFF' },
    { n: 9, frames: 128, screen: 'flashcards', mascot: 'guide', camera: 'orbit', text: 'turn the chapter into flashcards', silentText: 'Make flashcards', vo: 'Then turn the chapter into flashcards.', accent: '#4CC2FF' },
    { n: 10, frames: 128, screen: 'ankiStudy', camera: 'macro', text: 'They come back later', silentText: 'Comes back later', vo: 'They come back later for revision.', accent: '#4CC2FF' },

...
export const reelHowNotes: AdScript = {
  ...
  shots: [
    ...
    { n: 2, frames: 129, screen: 'progress', mascot: 'guide', camera: 'push', text: 'then the Notes tab', silentText: 'My Progress, then Notes', vo: 'Open My Progress, then the Notes tab.', accent: '#22D3A6' },
    ...
    { n: 4, frames: 129, screen: 'userNotesEdit', camera: 'settle', text: 'then start typing', silentText: 'Title it, then type', vo: 'Give it a title, then start typing.', accent: '#4CC2FF' },
    { n: 5, frames: 129, screen: 'noteToolbar', camera: 'macro', text: 'headings, bullets and a highlighter', silentText: 'Headings, bullets, highlighter', vo: 'The toolbar adds headings, bullets and a highlighter.', accent: '#7C5CFF' },
    { n: 6, frames: 129, screen: 'userNotesPreview', camera: 'push', text: 'turns it back into a document', silentText: 'It reads as a document', vo: 'Read note turns it back into a document.', accent: '#7C5CFF' },
    ...
    { n: 8, frames: 129, screen: 'userNotesMedia', camera: 'settle', text: 'a video, a recording or a PDF', silentText: 'Photo, video, audio, PDF', vo: 'A photo, a video, a recording or a PDF.', accent: '#F5B301' },
    { n: 9, frames: 128, screen: 'userNotesMedia', camera: 'macro', text: 'keep a copy or link it', silentText: 'Copy, or link', vo: 'Then it asks whether to keep a copy or link it.', accent: '#FF4D8D' },
    { n: 10, frames: 128, screen: 'notesBottom', mascot: 'guide', camera: 'glideDown', text: 'survives the original being deleted', silentText: 'A copy is safe. It costs space.', vo: 'A copy survives the original being deleted, and costs space.', accent: '#FF4D8D' },
    { n: 11, frames: 128, screen: 'notesBottom', camera: 'push', text: 'dies if you move the file', silentText: 'A link is free. It can break.', vo: 'A link costs nothing, and dies if you move the file.', accent: '#FF4D8D' },
    { n: 12, frames: 128, screen: 'notesBottom', camera: 'glideDown', text: 'Orbit offers to keep a copy', silentText: 'A broken link is one tap', vo: 'If a link ever breaks, Orbit offers to keep a copy.', accent: '#22D3A6' },
    { n: 13, frames: 128, screen: 'userNotes', mascot: 'guide', camera: 'macro', text: 'there is no limit', silentText: 'No limit. Nothing leaves.', vo: 'None of it leaves your phone, and there is no limit.', accent: '#22D3A6' },

...
export const reelNotes: AdScript = {
  ...
  shots: [
    ...
    { n: 2, frames: 129, screen: 'userNotes', mascot: 'guide', camera: 'push', text: 'Your own notes', silentText: 'Your own notes', vo: 'Write it down right there.', accent: '#22D3A6' },
    { n: 3, frames: 129, screen: 'userNotesEdit', camera: 'macro', text: 'Headings. Bullets. Highlighting.', silentText: 'Headings. Bullets. Highlighting.', vo: 'Headings, bullets and highlighting.', accent: '#22D3A6' },
    { n: 4, frames: 129, screen: 'userNotesPreview', camera: 'settle', text: 'Clean notes', silentText: 'Clean notes', vo: 'Then it still looks like a proper set of notes.', accent: '#4CC2FF' },
    { n: 5, frames: 129, screen: 'userNotesEdit', mascot: 'guide', camera: 'macro', text: 'Handwritten notes', silentText: 'Handwritten notes', vo: 'You can handwrite on a blank page too.', accent: '#7C5CFF' },
    { n: 6, frames: 129, screen: 'userNotesEdit', camera: 'macro', text: 'Palm rejection', silentText: 'Palm rejection', vo: 'Rest your palm down and keep writing.', accent: '#7C5CFF' },
    { n: 7, frames: 129, screen: 'userNotesMedia', camera: 'glideDown', text: 'Add a recording', silentText: 'Add a recording', vo: 'Got a recording from the ward round? Keep it with the note.', accent: '#FF4D8D' },
    { n: 8, frames: 129, screen: 'userNotesMedia', camera: 'push', text: 'Video or PDF', silentText: 'Video or PDF', vo: 'You can attach a video or PDF too.', accent: '#FF4D8D' },
    { n: 9, frames: 128, screen: 'userNotesMedia', mascot: 'guide', camera: 'macro', text: 'Copy or link', silentText: 'Copy or link', vo: 'And choose whether to keep a copy or just link to it.', accent: '#FF4D8D' },
    { n: 10, frames: 128, screen: 'notesBottom', camera: 'glideDown', text: 'Keep it together', silentText: 'Keep it together', vo: 'All of that can stay together in the same note.', accent: '#F5B301' },
    { n: 11, frames: 128, screen: 'userNotes', mascot: 'guide', camera: 'push', text: 'Stays on your phone', silentText: 'Stays on your phone', vo: 'Your notes stay on your phone.', accent: '#22D3A6' },
    ...
    { n: 13, frames: 128, screen: 'home', camera: 'pull', text: 'Notes + question bank', silentText: 'Notes + question bank', vo: 'And the notes sit alongside the question bank.', accent: '#4CC2FF' },

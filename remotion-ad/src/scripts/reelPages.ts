...
export const reelPages: AdScript = {
  ...
  shots: [
    ...
    { n: 5, frames: 129, screen: 'pageRefAddBook', camera: 'macro', text: 'Your book, your edition', silentText: 'Your book, your edition', vo: 'Your book and your edition and your page.', accent: '#4CC2FF' },
    ...
    { n: 11, frames: 128, screen: 'browse', camera: 'trackLeft', text: 'Every subject, every year', silentText: 'Every subject, every year', vo: 'Every subject and every year, one page at a time.', accent: '#FF4D8D' },

...
export const reelProgress: AdScript = {
  ...
  shots: [
    ...
    { n: 11, frames: 95, screen: 'notes', camera: 'trackRight', text: 'And your own notes', silentText: 'And your own notes', vo: 'And your own notes, on this phone only.', accent: '#22D3A6' },

...
export const reelReminder: AdScript = {
  ...
  shots: [
    ...
    { n: 4, frames: 129, screen: 'progress', camera: 'push', text: 'Nothing at all if you have already studied', silentText: 'Nothing if you already studied', vo: 'Nothing at all if you have already studied today.', focus: 0.45, accent: '#4CC2FF' },
    { n: 5, frames: 129, screen: 'progressBottom', camera: 'glideDown', text: 'it stops for a week after three you ignore', silentText: 'It stops after three you ignore', vo: 'And it stops for a week after three you ignore.', focus: 0.5, accent: '#22D3A6' },
    { n: 6, frames: 129, screen: 'home', mascot: 'guide', camera: 'macro', text: 'Never come back and play', silentText: 'It has nothing to sell you', vo: 'It never says come back and play.', focus: 0.5, accent: '#22D3A6' },
    ...
    { n: 9, frames: 128, screen: 'settings', camera: 'settle', text: 'You choose the hour', silentText: 'You choose the hour', vo: 'You choose the hour it arrives.', focus: 0.4, accent: '#FF4D8D' },
    ...
    { n: 13, frames: 128, screen: 'progress', camera: 'push', text: 'A reminder worth leaving on', silentText: 'A reminder worth keeping on', vo: 'A reminder worth leaving on.', accent: '#22D3A6' },

...
export const reelRepeats: AdScript = {
  ...
  shots: [
    ...
    { n: 7, frames: 129, screen: 'noteBody', camera: 'glideDown', text: 'The way examiners read it', silentText: 'Written exam-shaped', vo: 'Structured the way examiners read it.', accent: '#FF4D8D' },
    { n: 8, frames: 129, screen: 'plateBrachial', camera: 'settle', text: 'The diagram that question needs', silentText: 'And its own diagram', vo: 'With the diagram that question needs.', accent: '#22D3A6' },
    { n: 9, frames: 128, screen: 'chapterDiagrams', camera: 'glideDown', text: 'Hand-drawn for that question', silentText: 'Hand-drawn for that question', vo: 'Hand-drawn for that question rather than borrowed.', accent: '#22D3A6' },
    { n: 10, frames: 128, screen: 'askai', camera: 'push', text: 'Ask anything', silentText: 'Stuck? Ask the AI', vo: 'Ask anything and it explains properly.', accent: '#7C5CFF' },
    { n: 11, frames: 128, screen: 'flashcards', camera: 'orbit', text: 'Turn any chapter into flashcards', silentText: 'Any chapter to flashcards', vo: 'Turn any chapter into flashcards.', accent: '#4CC2FF' },
    { n: 12, frames: 128, screen: 'apkgHub', camera: 'push', text: 'Import your own Anki deck', silentText: 'Import your Anki deck', vo: 'Import your own Anki deck.', accent: '#4CC2FF' },
    { n: 13, frames: 128, screen: 'timer', camera: 'push', text: 'A tree grows', silentText: 'Focus, and a tree grows', vo: 'Start a session. A tree grows.', accent: '#22D3A6' },

...
export const reelRepeats: AdScript = {
  ...
  shots: [
    ...
    { n: 9, frames: 128, screen: 'chapterDiagrams', camera: 'glideDown', text: 'Two hundred and fifty diagrams', silentText: "250 exam diagrams", vo: 'Two hundred and fifty diagrams, hand-drawn.', accent: '#22D3A6' },

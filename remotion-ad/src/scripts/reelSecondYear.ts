...
export const reelSecondYear: AdScript = {
  ...
  shots: [
    { n: 1, frames: 129, screen: null, mascot: 'hero', camera: 'settle', text: 'Patho + Pharma', silentText: 'Patho + Pharma', vo: 'Pathology and Pharmacology in the same week. Great.', accent: '#FF4D8D' },
    { n: 2, frames: 129, screen: 'browseSecond', mascot: 'guide', camera: 'trackLeft', text: 'Patho. Pharma. Micro. Forensic.', silentText: 'Patho. Pharma. Micro. Forensic.', vo: 'Then Micro and Forensic show up too.', accent: '#FF4D8D' },
    { n: 3, frames: 129, screen: 'questionsChapters', camera: 'push', text: 'Sorted by chapter', silentText: 'Sorted by chapter', vo: 'At least they’re split down by chapter.', focus: 0.35, accent: '#4CC2FF' },
    { n: 4, frames: 129, screen: 'questionsLeaf', camera: 'macro', text: 'Repeat frequency', silentText: 'Repeat frequency', vo: 'The circle shows how often the question repeats.', focus: 0.28, accent: '#F5B301' },
    { n: 5, frames: 129, screen: 'questionsLeaf', mascot: 'guide', camera: 'push', text: 'Study the 4s first', silentText: 'Study the 4s first', vo: 'So start with the fours before the ones.', focus: 0.3, accent: '#F5B301' },
    { n: 6, frames: 129, screen: 'noteHero', camera: 'push', text: 'Triple-tap for the answer', silentText: 'Triple-tap for the answer', vo: 'Triple-tap for the written answer.', accent: '#7C5CFF' },
    ...
    { n: 8, frames: 129, screen: 'plateStomach', camera: 'settle', text: 'Diagram included', silentText: 'Diagram included', vo: 'The diagram you need is there too.', accent: '#22D3A6' },
    { n: 9, frames: 128, screen: 'flashcards', mascot: 'guide', camera: 'orbit', text: 'Chapter → cards', silentText: 'Chapter → cards', vo: 'One tap and the chapter can become flashcards.', accent: '#4CC2FF' },
    { n: 10, frames: 128, screen: 'ankiStudy', camera: 'macro', text: 'Import your Anki deck', silentText: 'Import your Anki deck', vo: 'Already using Anki? Bring that in too.', accent: '#4CC2FF' },
    { n: 11, frames: 128, screen: 'attendance', camera: 'push', text: 'Attendance too', silentText: 'Attendance too', vo: 'And keep your attendance in the same app.', focus: 0.4, accent: '#22D3A6' },
    { n: 12, frames: 128, screen: 'timer', mascot: 'guide', camera: 'push', text: 'Focus. Grow.', silentText: 'Focus. Grow.', vo: 'Then focus for twenty-five minutes and let the tree grow.', accent: '#22D3A6' },
    { n: 13, frames: 128, screen: 'home', camera: 'pull', text: 'One app for second year', silentText: 'One app for second year', vo: 'Second year, all in one place.', accent: '#FF4D8D' },

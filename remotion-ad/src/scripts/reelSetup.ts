...
export const reelSetup: AdScript = {
  ...
  shots: [
    { n: 1, frames: 129, screen: null, mascot: 'hero', camera: 'settle', text: 'No account, no card', silentText: 'No account. No card.', vo: 'No account. No card. No trial.', accent: '#7C5CFF' },
    ...
    { n: 7, frames: 129, screen: 'tourGestures', camera: 'push', text: 'Every tap does something', silentText: 'Tap, double-tap, triple-tap', vo: 'Every tap, double tap and triple tap does something.', accent: '#F5B301' },

...
export const reelSixHours: AdScript = {
  ...
  shots: [
    ...
    { n: 6, frames: 129, screen: 'questionsLeaf', camera: 'macro', text: 'Triple-tap it', silentText: 'Triple-tap. Type nothing', vo: 'Triple-tap it. Type nothing at all.', focus: 0.28, accent: '#FF4D8D' },
    { n: 7, frames: 129, screen: 'noteHero', camera: 'push', text: 'A full handwritten answer', silentText: 'A full answer in seconds', vo: 'A full handwritten answer, in seconds.', accent: '#FF4D8D' },
    { n: 8, frames: 129, screen: 'plateCalots', camera: 'settle', text: 'The diagram comes with it', silentText: 'With the diagram you must draw', vo: 'The diagram comes with it, already drawn.', accent: '#22D3A6' },
    { n: 9, frames: 128, screen: 'askai', camera: 'push', text: 'Ask it anything', silentText: 'Stuck? Ask the AI', vo: 'Ask it anything and it explains properly.', accent: '#7C5CFF' },
    { n: 10, frames: 128, screen: 'flashcards', camera: 'orbit', text: 'Turn the chapter into flashcards', silentText: 'Chapter to flashcards', vo: 'Turn the chapter into flashcards.', accent: '#4CC2FF' },
    { n: 11, frames: 128, screen: 'timer', camera: 'push', text: 'Twenty-five minutes', silentText: '25 minutes. Phone down', vo: 'Twenty-five minutes. Phone down.', accent: '#22D3A6' },
    { n: 12, frames: 128, screen: 'music', camera: 'trackRight', text: 'Your own music', silentText: 'Your own music, from your phone', vo: 'Your own music. Nothing uploads.', accent: '#22D3A6' },
    { n: 13, frames: 128, screen: 'home', camera: 'hero', text: 'It still works offline', silentText: 'Hostel wifi died? Fine', vo: 'Wifi gone? It still works offline.', accent: '#7C5CFF' },

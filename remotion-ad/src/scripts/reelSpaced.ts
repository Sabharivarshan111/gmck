...
export const reelSpaced: AdScript = {
  ...
  shots: [
    ...
    { n: 3, frames: 129, screen: 'questionsLeaf', mascot: 'guide', camera: 'push', text: 'Orbit remembers when', silentText: 'Orbit remembers when', vo: 'Orbit remembers when, and what happens next.', focus: 0.3, accent: '#7C5CFF' },
    ...
    { n: 5, frames: 129, screen: 'progressBottom', camera: 'push', text: 'It comes back in a day', silentText: 'It comes back in a day', vo: 'It comes back in a day. Then in six.', focus: 0.32, accent: '#4CC2FF' },
    ...
    { n: 7, frames: 129, screen: 'ankiStudy', camera: 'push', text: 'The same idea as Anki', silentText: 'The same idea Anki uses', vo: 'The same spacing idea Anki is built on.', focus: 0.3, accent: '#F5B301' },

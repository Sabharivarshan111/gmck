...
export const reelYours: AdScript = {
  ...
  shots: [
    ...
    { n: 5, frames: 129, screen: 'themeCustomizer', mascot: 'guide', camera: 'macro', text: 'Or build your own', silentText: 'Or build your own', vo: 'Or build your own from four colours.', accent: '#7C5CFF' },
    { n: 6, frames: 129, screen: 'glassHome', camera: 'settle', text: 'Your own picture behind it', silentText: 'Your own picture behind it', vo: 'Put your own picture behind it.', accent: '#4CC2FF' },
    { n: 7, frames: 129, screen: 'glassNotes', camera: 'push', text: 'The cards let it through', silentText: 'The cards let it through', vo: 'The cards let it through, and stay readable.', accent: '#4CC2FF' },
    { n: 8, frames: 129, screen: 'homeEditPicture', mascot: 'guide', camera: 'macro', text: 'Move the home screen around', silentText: 'Move the home screen around', vo: 'Move the home screen around while you are there.', accent: '#22D3A6' },
    { n: 9, frames: 128, screen: 'homeEditTaller', camera: 'push', text: 'Hold a block to pick it up', silentText: 'Hold a block, pick it up', vo: 'Hold a block to pick it up.', accent: '#22D3A6' },
    { n: 10, frames: 128, screen: 'homeEditTaller', camera: 'macro', text: 'Drag the edge to make it wider', silentText: 'Drag the edge to resize it', vo: 'Drag the edge to make it wider, or taller.', accent: '#22D3A6' },
    { n: 11, frames: 128, screen: 'settings', camera: 'macro', text: 'One button holds everything else', silentText: 'One button holds the rest', vo: 'One button holds everything else adjustable.', accent: '#F5B301' },
    { n: 12, frames: 128, screen: 'settings', camera: 'glideDown', text: 'Text size, sound, haptics', silentText: 'Text size, sound, haptics', vo: 'Text size, sound and haptics are all in there.', accent: '#F5B301' },
    { n: 13, frames: 128, screen: 'noteToolbar', camera: 'push', text: 'Even your own notes get a font', silentText: 'Even your notes get a font', vo: 'Even your own notes get a font and a highlighter.', accent: '#FF4D8D' },

...
export const thePattern: AdScript = {
  ...
  shots: [
    ...
    { n: 2, screen: 'questions', camera: 'pull', text: 'Most have been asked before', vo: 'We did. Most of them have already been asked.', accent: '#F5B301' },
    { n: 3, screen: 'browse', camera: 'trackLeft', text: 'Every year, every subject', vo: 'First year to final year. Twenty-five subjects. One bank.', accent: '#7C5CFF' },
    { n: 4, screen: 'questionsChapters', camera: 'push', text: 'Sorted to your chapter', vo: 'Every past question, sorted down to your chapter.', focus: 0.35 },
    ...
    { n: 12, screen: 'chapterDiagrams', camera: 'glideDown', text: 'Beside the text it explains', vo: 'Every diagram sits beside the text it explains.' },
    { n: 13, screen: 'plateUlnar', camera: 'macro', text: 'Every part labelled', vo: 'Every part labelled the way you have to draw it.', accent: '#22D3A6' },

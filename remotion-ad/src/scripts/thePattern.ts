...
export const thePattern: AdScript = {
  ...
  pitch: '+0Hz',
  shots: [
    { n: 1, screen: 'browse', camera: 'macro', text: '2,025 questions', vo: 'Your university repeats its questions. Nobody counted them.', focus: 0.35, accent: '#F5B301' },
    ...
    { n: 4, screen: 'questionsChapters', camera: 'push', text: '5,545 questions', vo: 'Five and a half thousand questions, already sorted.', focus: 0.35 },
    { n: 5, screen: 'questionsLeaf', camera: 'macro', text: 'Stars mean frequency', vo: 'The stars are not decoration. They are frequency.', focus: 0.28, accent: '#F5B301' },
    { n: 6, screen: 'questionsLeaf', camera: 'orbit', text: 'Asked Feb 23. Aug 19.', vo: 'Every year it was asked is printed on it.', focus: 0.28 },
    { n: 7, screen: 'questionsLeaf', camera: 'macro', text: 'Triple-tap', vo: 'Triple-tap any question. Watch what happens.', focus: 0.28, accent: '#FF4D8D' },
    ...
    { n: 20, screen: 'userNotesEdit', camera: 'macro', text: 'Write. Draw.', vo: 'Write your own notes. Draw on them with a stylus.', focus: 0.35, accent: '#FF8A3D' },
    { n: 21, screen: 'userNotesEdit', camera: 'macro', text: 'Palm rejection', vo: 'Rest your hand on the screen. It ignores your palm.', focus: 0.5, accent: '#FF8A3D' },
    { n: 22, screen: 'userNotesPreview', camera: 'pull', text: 'Your ward photos', vo: 'Photos, recordings and PDFs live inside your notes.', accent: '#FF8A3D' },
    ...
    { n: 27, screen: 'themeCustomizer', camera: 'push', text: 'Four themes', vo: 'Four themes, or build your own from four colours.', accent: '#4CC2FF' },
    { n: 28, screen: 'wallpaperCustomizer', camera: 'macro', text: 'Liquid glass', vo: 'Set a wallpaper and the surfaces bend the light.', focus: 0.45, accent: '#4CC2FF' },
    { n: 29, screen: 'home', camera: 'hero', text: 'Orbit MBBS', vo: 'Every question, every plate, every note. Offline.' },
    { n: 30, screen: 'outroCard', camera: 'settle', text: 'Orbit MBBS', vo: 'Stop studying blind. Orbit MBBS. On Google Play.', accent: '#7C5CFF' },
  ],
};

...
export const twoAM: AdScript = {
  ...
  pitch: '+1Hz',
  shots: [
    { n: 1, screen: 'home', camera: 'macro', text: 'Two AM. The exam is at nine.', vo: 'Two AM. The exam is at nine.', accent: '#F5B301' },
    { n: 2, screen: 'browse', camera: 'push', text: 'Three textbooks open', vo: 'Three textbooks open on the floor. None of them agree.', accent: '#F5B301' },
    ...
    { n: 5, screen: 'questionsLeaf', camera: 'glideDown', text: 'Filter by repeats', vo: 'Filter by repeated questions. The top twenty are right here.', accent: '#F5B301' },
    { n: 6, screen: 'questionsLeaf', camera: 'macro', text: 'Last 5 years starred', vo: 'Every question that came in the last five years, starred.', focus: 0.28, accent: '#F5B301' },
    { n: 7, screen: 'questionsLeaf', camera: 'macro', text: 'Triple-tap', vo: 'Triple-tap the first one.', focus: 0.28, accent: '#FF4D8D' },
    ...
    { n: 19, screen: 'questionsLeaf', camera: 'macro', text: 'Tick it off', vo: "Tick it. That's one you never have to reopen.", focus: 0.28 },
    ...
    { n: 28, screen: 'themeCustomizer', camera: 'orbit', text: 'Your colours', vo: 'Make it look how you want. Even the colours.', accent: '#4CC2FF' },

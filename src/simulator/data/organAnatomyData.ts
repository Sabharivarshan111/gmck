...
export const ORGAN_ANATOMY_DATABASE: Record<string, DetailedOrganAnatomy> = {
  ...
  eye: {
    ...
    quadrantOrCavity: 'Orbit',
    surfaceLandmarks: 'Globe occupies anterior orbit; corneal light reflex and pupillary position are key surface references.',
    dimensionsAndWeight: 'Adult globe approximately 24 mm anteroposterior diameter.',
    arterialSupply: ['Ophthalmic artery via central retinal and ciliary branches.'],
    venousDrainage: ['Superior and inferior ophthalmic veins drain to cavernous sinus; central retinal vein drains retina.'],
    innervation: { sympathetic: 'Postganglionic fibers from superior cervical ganglion via carotid plexus.', parasympathetic: 'CN III via ciliary ganglion to sphincter pupillae and ciliary muscle.', somaticOrSensory: 'CN II for vision; V1 via nasociliary/long ciliary nerves for corneal sensation.', referredPain: 'Ocular pain may refer to V1 forehead/orbit.' },
    lymphaticDrainage: ['Conjunctival/adnexal lymphatics drain mainly to preauricular/parotid and submandibular nodes; the globe itself has no conventional lymphatics.'],
    musculoskeletalRelations: ['Extraocular muscles form a cone around optic nerve; globe lies anterior to orbital fat and neurovascular structures.'],
    histologyAndPhysiology: 'Cornea, uvea, lens, retina and humors form the optical system; phototransduction occurs in rods/cones and signals exit through optic nerve.',
    clinicalBedsideSigns: ['Pupillary light reflex tests CN II afferent and CN III efferent limbs.', 'Corneal reflex tests V1 afferent and VII efferent blink response.'],
    nmcMbbssVivaPearls: ['Aqueous drains through trabecular meshwork and Schlemm canal.', 'Macula/fovea mediate highest visual acuity.'],
    radiologicalCorrelation: 'CT orbit is useful for trauma/foreign body; MRI is preferred for optic nerve and soft tissues.',
    surgicalApproaches: 'Anterior segment procedures use corneal/limbal access; orbital surgery requires protection of optic nerve and extraocular muscles.',
  },

  ureter: {
    id: 'ureter',
    name: 'Ureter & Collecting System',
    latinName: 'Ureter',
    system: 'Urinary System',
    quadrantOrCavity: 'Retroperitoneum from renal pelvis to urinary bladder',
    surfaceLandmarks: 'Descends on psoas, crosses pelvic brim near iliac vessels, then enters bladder obliquely.',
    dimensionsAndWeight: 'About 25–30 cm long; muscular tube with three classic constriction sites.',
    arterialSupply: ['Segmental branches from renal, gonadal, aortic/common iliac and vesical/uterine arteries create a longitudinal adventitial plexus.'],
    venousDrainage: ['Ureteric veins drain segmentally alongside the arteries: upper ureter to renal/gonadal veins, middle ureter to common iliac veins, and lower ureter to internal iliac/vesical venous tributaries.'],
    innervation: { sympathetic: 'T10–L2 via renal, aortic and hypogastric plexuses.', parasympathetic: 'Pelvic splanchnic S2–S4 to distal ureter.', somaticOrSensory: 'Visceral afferents accompany sympathetics, especially T10–L2.', referredPain: 'Loin-to-groin pain; may radiate to testis/labium as stone descends.' },
    lymphaticDrainage: ['Upper ureter to lumbar nodes; middle to common iliac; lower to internal/external iliac nodes.'],
    musculoskeletalRelations: ['Lies on psoas major; gonadal vessels cross anteriorly; pelvic relations differ by sex.'],
    histologyAndPhysiology: 'Urothelium with muscular wall generates peristalsis to propel urine; oblique intramural segment helps prevent vesicoureteric reflux.',
    clinicalBedsideSigns: ['Renal colic is severe waxing/waning flank pain with restlessness.', 'Three common narrowing sites: PUJ, iliac-vessel crossing, VUJ.'],
    nmcMbbssVivaPearls: ['Water-under-the-bridge: ureter passes under uterine artery.', 'In males ureter passes under ductus deferens near bladder.'],
    radiologicalCorrelation: 'CT KUB is standard for many ureteric calculi; CT urography shows collecting system and ureter.',
    surgicalApproaches: 'Ureteric surgery preserves adventitial blood supply and avoids circumferential stripping.',
  },
  ...
  spinal_cord: {
    ...
    system: 'Central Nervous System',
    quadrantOrCavity: 'Vertebral canal',
    surfaceLandmarks: 'Extends from foramen magnum to approximately L1–L2 in adults; lumbar puncture is performed below cord termination.',
    dimensionsAndWeight: 'About 42–45 cm long in adults with cervical and lumbosacral enlargements.',
    arterialSupply: ['The anterior spinal artery is formed by vertebral-artery branches; paired posterior spinal arteries arise from vertebral/PICA branches, and both are reinforced by segmental medullary arteries from vertebral, deep cervical, posterior intercostal and lumbar sources, including the great anterior segmental medullary artery (Adamkiewicz), usually from a lower posterior intercostal or upper lumbar artery.'],
    venousDrainage: ['Intrinsic veins drain to spinal venous plexuses and epidural vertebral venous network.'],
    innervation: { sympathetic: 'Not applicable as an efferent supply; sympathetic preganglionic neurons arise in intermediolateral columns T1–L2.', parasympathetic: 'Sacral parasympathetic preganglionic neurons arise S2–S4.', somaticOrSensory: 'Ascending sensory and descending motor tracts plus segmental roots.', referredPain: 'Cord pathology may produce dermatomal/radicular symptoms rather than a single referred-pain pattern.' },
    lymphaticDrainage: ['CSF and CNS interstitial drainage communicate with meningeal/lymphatic pathways rather than conventional parenchymal lymphatics.'],
    musculoskeletalRelations: ['Enclosed by vertebral canal, meninges and epidural fat; roots descend as cauda equina below conus medullaris.'],
    histologyAndPhysiology: 'Central gray matter surrounds central canal; peripheral white matter carries ascending and descending tracts.',
    clinicalBedsideSigns: ['Upper motor neuron signs below a cord lesion; segmental LMN signs may occur at lesion level.', 'Sensory level is an important bedside localizing sign.'],
    nmcMbbssVivaPearls: ['Conus usually ends L1–L2 in adults.', 'Lumbar puncture commonly L3–L4 or L4–L5.'],
    radiologicalCorrelation: 'MRI is investigation of choice for cord compression, myelitis, syrinx and intramedullary lesions.',
    surgicalApproaches: 'Posterior decompression/laminectomy and intradural approaches depend on lesion level and location.',
  },

  pelvis: {
    id: 'pelvis',
    name: 'Bony Pelvis',
    latinName: 'Pelvis Ossea',
    system: 'Skeletal System',
    quadrantOrCavity: 'Pelvic girdle',
    surfaceLandmarks: 'ASIS, iliac crest, pubic tubercle and ischial tuberosity are key palpable landmarks.',
    dimensionsAndWeight: 'Formed by paired hip bones plus sacrum and coccyx; dimensions vary by sex and individual.',
    arterialSupply: ['Regional osseous supply from branches of internal/external iliac, obturator, gluteal and iliolumbar vessels.'],
    venousDrainage: ['Pelvic osseous and periosteal veins drain through obturator, gluteal, iliolumbar and sacral venous channels into the internal/common iliac venous plexuses.'],
    innervation: { sympathetic: 'No specific autonomic supply to bone beyond vasomotor fibers.', parasympathetic: 'None specific.', somaticOrSensory: 'Periosteal and articular sensory innervation from regional somatic nerves.', referredPain: 'Pelvic/hip pathology may refer to groin, buttock or thigh.' },
    lymphaticDrainage: ['Regional soft tissues drain mainly to iliac and sacral nodal groups.'],
    musculoskeletalRelations: ['Transfers axial load to lower limbs through sacroiliac joints and acetabula; pelvic floor attaches to bony ring.'],
    histologyAndPhysiology: 'Cortical and trabecular bone provide ring stability and load transfer.',
    clinicalBedsideSigns: ['Pelvic ring injury may cause instability and major hemorrhage.', 'Pelvic compression should not be repeatedly performed in suspected unstable trauma.'],
    nmcMbbssVivaPearls: ['Hip bone = ilium, ischium and pubis.', 'Pelvic brim separates greater and lesser pelvis.'],
    radiologicalCorrelation: 'AP pelvis radiograph is initial trauma imaging; CT defines complex fractures.',
    surgicalApproaches: 'Approaches depend on anterior/posterior ring or acetabular pathology and nearby neurovascular structures.',
  },
  ...
  prostate: {
    ...
    quadrantOrCavity: 'Subperitoneal lesser pelvis, immediately inferior to bladder',
    surfaceLandmarks: 'Posterior surface is palpable on digital rectal examination through anterior rectal wall.',
    dimensionsAndWeight: 'Approximately 20 g in young adult; classically about 3 × 4 × 2 cm.',
    arterialSupply: ['Branches of inferior vesical, middle rectal and internal pudendal arteries.'],
    venousDrainage: ['Prostatic venous plexus drains to internal iliac veins and communicates with vertebral venous plexus.'],
    innervation: { sympathetic: 'Hypogastric/pelvic plexus fibers contribute to smooth muscle and ejaculation.', parasympathetic: 'Pelvic splanchnic S2–S4 through pelvic plexus.', somaticOrSensory: 'Visceral afferents travel with pelvic autonomics.', referredPain: 'Pelvic/perineal discomfort may occur in prostatitis.' },
    lymphaticDrainage: ['Mainly internal iliac, obturator and sacral nodes; external iliac drainage may contribute.'],
    musculoskeletalRelations: ['Apex lies on urogenital diaphragm/external sphincter; base relates to bladder neck; posteriorly rectum.'],
    histologyAndPhysiology: 'Fibromusculoglandular organ contributing secretions to semen; peripheral, central and transition zones are clinically important.',
    clinicalBedsideSigns: ['BPH enlarges transition zone and may obstruct urinary outflow.', 'Prostate carcinoma commonly arises in peripheral zone and may be palpable posteriorly.'],
    nmcMbbssVivaPearls: ['BPH: transition/periurethral region.', 'Carcinoma: commonly peripheral zone.'],
    radiologicalCorrelation: 'Multiparametric MRI is central to prostate cancer localization and staging.',
    surgicalApproaches: 'TURP addresses obstructing adenoma; radical prostatectomy requires preservation of neurovascular bundles when appropriate.',
  },
  ...
  skin: {
    ...
    quadrantOrCavity: 'Whole body surface',
    surfaceLandmarks: 'Continuous external covering with regional variation in thickness, hair and adnexa.',
    dimensionsAndWeight: 'Largest organ by surface area; roughly 1.5–2 m² in adults.',
    arterialSupply: ['Cutaneous arteries arise from direct and musculocutaneous/septocutaneous perforators of regional named arteries, which feed deep dermal and subdermal plexuses before supplying the superficial dermal plexus.'],
    venousDrainage: ['Superficial venous plexuses drain through regional superficial and deep veins.'],
    innervation: { sympathetic: 'Sympathetic fibers regulate vasomotor tone, sweating and arrector pili.', parasympathetic: 'No major parasympathetic cutaneous supply.', somaticOrSensory: 'Free nerve endings and specialized receptors convey pain, temperature, touch, pressure and vibration.', referredPain: 'Dermatomes are used to localize spinal root and cord lesions.' },
    lymphaticDrainage: ['Superficial lymphatics drain to regional nodal basins according to body region.'],
    musculoskeletalRelations: ['Skin overlies superficial fascia and deep fascia; mobility varies by tethering and subcutaneous tissue.'],
    histologyAndPhysiology: 'Keratinized stratified squamous epidermis overlies dermis; barrier, thermoregulation, sensation, immunity and vitamin D synthesis are major functions.',
    clinicalBedsideSigns: ['Assess color, turgor, temperature, rash morphology, ulcers and pressure injury.', 'ABCDE criteria aid melanoma screening.'],
    nmcMbbssVivaPearls: ['Thick skin lacks hair follicles and sebaceous glands.', 'Epidermis is avascular.'],
    radiologicalCorrelation: 'High-frequency ultrasound and MRI may characterize selected skin/soft-tissue lesions; diagnosis is usually clinical/histologic.',
    surgicalApproaches: 'Incisions follow relaxed skin tension lines when feasible; graft/flap choice depends on defect depth and vascularity.',
  },
  ...
  knee: {
    ...
    quadrantOrCavity: 'Lower limb',
    surfaceLandmarks: 'Patella, tibial tuberosity, joint lines and femoral condyles are palpable landmarks.',
    dimensionsAndWeight: 'Largest synovial joint; modified hinge articulation among femur, tibia and patella.',
    arterialSupply: ['Genicular anastomosis from popliteal, femoral/profunda and anterior tibial recurrent branches.'],
    venousDrainage: ['Genicular veins drain mainly to popliteal/femoral venous systems.'],
    innervation: { sympathetic: 'Vasomotor fibers accompany arteries.', parasympathetic: 'None specific.', somaticOrSensory: 'Articular branches from femoral, tibial, common fibular and obturator nerves.', referredPain: 'Hip pathology may refer pain to knee; knee pathology localizes to joint line/anterior or posterior compartments.' },
    lymphaticDrainage: ['Deep lymphatics drain chiefly to popliteal then deep inguinal/external iliac nodes.'],
    musculoskeletalRelations: ['ACL/PCL, collateral ligaments, menisci, quadriceps-patellar mechanism and popliteal structures stabilize/relate to joint.'],
    histologyAndPhysiology: 'Hyaline cartilage covers articular surfaces; fibrocartilaginous menisci deepen tibial surfaces and distribute load.',
    clinicalBedsideSigns: ['Lachman/anterior drawer test ACL; posterior drawer PCL; McMurray/Thessaly assess menisci.', 'Effusion can be assessed by bulge/patellar tap tests.'],
    nmcMbbssVivaPearls: ['ACL prevents anterior tibial translation.', 'PCL prevents posterior tibial translation.', 'Medial meniscus is less mobile and more commonly injured.'],
    radiologicalCorrelation: 'X-ray assesses fracture/arthritis; MRI is best for menisci, cruciate ligaments and cartilage.',
    surgicalApproaches: 'Arthroscopy provides minimally invasive access; open approaches depend on compartment and reconstruction.',
  },
  ...
  uterus: {
    ...
    quadrantOrCavity: 'Lesser pelvis between bladder and rectum',
    surfaceLandmarks: 'Normally anteverted and anteflexed; fundus rises above pelvis with pregnancy.',
    dimensionsAndWeight: 'Nulliparous uterus roughly 7.5 × 5 × 2.5 cm, with major physiologic variation.',
    arterialSupply: ['Uterine artery from internal iliac crosses ureter and anastomoses with ovarian artery.'],
    venousDrainage: ['Uterine venous plexus drains to internal iliac veins; communicates with ovarian veins.'],
    innervation: { sympathetic: 'T10–L2 via hypogastric plexuses.', parasympathetic: 'Pelvic splanchnic S2–S4 to cervix/lower uterus and pelvic plexus.', somaticOrSensory: 'Upper uterine pain mainly follows sympathetics; cervix/upper vagina visceral afferents with pelvic parasympathetics.', referredPain: 'Labor pain changes distribution as uterine and perineal structures are engaged.' },
    lymphaticDrainage: ['Fundus to para-aortic and superficial inguinal via round ligament; body to external iliac; cervix to internal iliac/sacral nodes.'],
    musculoskeletalRelations: ['Supported by pelvic floor, cardinal/transverse cervical, uterosacral and pubocervical condensations; round ligament helps maintain anteversion.'],
    histologyAndPhysiology: 'Endometrium cycles under ovarian hormones; myometrium hypertrophies in pregnancy; cervix contains mucus-secreting glands.',
    clinicalBedsideSigns: ['Bimanual examination assesses uterine size, position, mobility and tenderness.', 'Cervical screening samples transformation zone.'],
    nmcMbbssVivaPearls: ['Water under the bridge: uterine artery crosses over ureter.', 'Cardinal and uterosacral supports are important in uterine prolapse prevention.'],
    radiologicalCorrelation: 'Pelvic ultrasound is first-line; MRI defines congenital anomalies, fibroids and malignancy extent.',
    surgicalApproaches: 'Hysterectomy may be abdominal, vaginal or laparoscopic; ureters and uterine vessels are critical landmarks.',
  },
  ...
  ovary: {
    ...
    latinName: 'Ovarium',
    system: 'Female Reproductive System',
    quadrantOrCavity: 'Lateral pelvic cavity in ovarian fossa',
    surfaceLandmarks: 'Located near lateral pelvic wall; position varies with age, parity and pregnancy.',
    dimensionsAndWeight: 'Approximately 3 × 2 × 1 cm in reproductive-age adults, with physiologic variation.',
    arterialSupply: ['Ovarian artery from abdominal aorta, with anastomosis from uterine artery.'],
    venousDrainage: ['The right ovarian vein ascends from the pampiniform ovarian plexus to drain directly into the IVC, while the left ovarian vein drains the left ovarian plexus into the left renal vein.'],
    innervation: { sympathetic: 'T10–T11 via ovarian/aortic plexus.', parasympathetic: 'Vagal/pelvic contributions described; autonomic role is mainly vascular/visceral.', somaticOrSensory: 'Visceral afferents travel with sympathetic fibers.', referredPain: 'Ovarian pain can refer to lower abdomen/groin around T10–T11 dermatomal distribution.' },
    lymphaticDrainage: ['Para-aortic (lumbar) nodes, reflecting gonadal embryologic origin.'],
    musculoskeletalRelations: ['Suspensory ligament carries ovarian vessels; ovarian ligament links ovary to uterus; mesovarium attaches to broad ligament.'],
    histologyAndPhysiology: 'Cortex contains follicles/corpora lutea; medulla contains vessels and stroma. Produces oocytes, estrogen, progesterone and inhibin.',
    clinicalBedsideSigns: ['Adnexal tenderness/mass on bimanual exam may suggest ovarian pathology.', 'Torsion classically presents with acute unilateral pelvic pain and nausea.'],
    nmcMbbssVivaPearls: ['Ovarian vessels run in suspensory ligament.', 'Lymph drains to para-aortic nodes, not primarily inguinal nodes.'],
    radiologicalCorrelation: 'Transvaginal ultrasound is first-line; Doppler helps assess torsion; MRI further characterizes complex masses.',
    surgicalApproaches: 'Laparoscopic cystectomy/oophorectomy requires awareness of ureter and infundibulopelvic ligament vessels.',
  },

  fallopian_tube: {
    id: 'fallopian_tube',
    name: 'Uterine (Fallopian) Tube',
    latinName: 'Tuba Uterina',
    system: 'Female Reproductive System',
    quadrantOrCavity: 'Upper free margin of broad ligament',
    surfaceLandmarks: 'Extends from uterine cornua toward ovary; fimbriae open into peritoneal cavity.',
    dimensionsAndWeight: 'Approximately 10 cm long; divided into intramural, isthmus, ampulla and infundibulum.',
    arterialSupply: ['Tubal branches of uterine and ovarian arteries.'],
    venousDrainage: ['Veins drain to uterine and ovarian venous systems.'],
    innervation: { sympathetic: 'T10–L2 through ovarian/uterine plexuses.', parasympathetic: 'Pelvic splanchnic contributions through pelvic plexus.', somaticOrSensory: 'Visceral afferents follow autonomic pathways.', referredPain: 'Tubal pathology may produce lower abdominal/pelvic pain.' },
    lymphaticDrainage: ['Mainly para-aortic via ovarian pathways, with some pelvic nodal drainage near uterine end.'],
    musculoskeletalRelations: ['Located in mesosalpinx; infundibulum and fimbriae relate closely to ovary.'],
    histologyAndPhysiology: 'Ciliated and secretory columnar epithelium supports gamete transport; ampulla is usual site of fertilization.',
    clinicalBedsideSigns: ['Ectopic pregnancy most commonly occurs in ampulla.', 'Tubal disease may contribute to infertility.'],
    nmcMbbssVivaPearls: ['Parts: intramural, isthmus, ampulla, infundibulum.', 'Ampulla is commonest site of fertilization and ectopic pregnancy.'],
    radiologicalCorrelation: 'Hysterosalpingography assesses tubal patency; ultrasound evaluates adnexal complications.',
    surgicalApproaches: 'Salpingectomy/salpingostomy may be laparoscopic; mesosalpinx vessels require careful control.',
  },
  ...
  placenta: {
    ...
    name: 'Placenta',
    latinName: 'Placenta',
    system: 'Obstetric / Fetomaternal Organ',
    quadrantOrCavity: 'Attached to gravid uterine wall',
    surfaceLandmarks: 'Fetal surface is smooth and covered by amnion with radiating chorionic vessels; maternal surface is divided into cotyledons.',
    dimensionsAndWeight: 'At term roughly 15–20 cm diameter, 2–3 cm thick and about 500 g, with wide physiologic variation.',
    arterialSupply: ['Maternal spiral arteries arise from radial branches of the uterine arteries and discharge into the intervillous space; the two fetal umbilical arteries arise from the internal iliac circulation and carry deoxygenated fetal blood to the placenta.'],
    venousDrainage: ['Maternal endometrial veins drain intervillous space; one umbilical vein returns oxygenated blood to fetus.'],
    innervation: { sympathetic: 'Placental parenchyma lacks conventional neural regulation comparable with adult organs.', parasympathetic: 'No meaningful direct parasympathetic innervation.', somaticOrSensory: 'No somatic sensory innervation of placental parenchyma.', referredPain: 'Placenta itself does not generate a characteristic referred-pain pattern.' },
    lymphaticDrainage: ['No conventional placental lymphatic drainage analogous to adult organs.'],
    musculoskeletalRelations: ['Anchored to decidua basalis; relation depends on implantation site and uterine anatomy.'],
    histologyAndPhysiology: 'Chorionic villi form fetomaternal exchange surface for gases, nutrients and waste and produce endocrine signals including hCG.',
    clinicalBedsideSigns: ['Placental location is assessed by ultrasound; previa may present with painless bleeding.', 'Abruption may present with painful bleeding, uterine tenderness and fetal compromise.'],
    nmcMbbssVivaPearls: ['Two umbilical arteries and one umbilical vein.', 'Placenta is hemochorial; maternal blood bathes chorionic villi.'],
    radiologicalCorrelation: 'Ultrasound assesses location, morphology, cord insertion and Doppler flow; MRI can assist placenta accreta spectrum assessment.',
    surgicalApproaches: 'Placental delivery is usually physiologic; placenta accreta spectrum may require planned multidisciplinary cesarean hysterectomy.',
  },
  ...
  // 22. PERIPHERAL NERVOUS SYSTEM — Z-Anatomy supplement
  peripheral_nerves: {
    id: 'peripheral_nerves',
    name: 'Peripheral Nerves & Plexuses',
    latinName: 'Systema Nervosum Periphericum',
    system: 'Peripheral Nervous System',
    quadrantOrCavity: 'Cranial, cervical, thoracic, upper-limb and lower-limb neurovascular planes',
    surfaceLandmarks:
      'Major peripheral nerves travel in predictable fascial and neurovascular planes: brachial plexus from the posterior triangle into the axilla; median/ulnar/radial nerves through the arm and forearm; lumbar and sacral plexuses across the posterior abdominal wall and pelvis; sciatic nerve midway between the greater trochanter and ischial tuberosity.',
    dimensionsAndWeight:
    ...
    innervation: {
      sympathetic:
        'Postganglionic sympathetic fibers hitch-hike along peripheral nerves and vessels to supply sweat glands, arrector pili and vascular smooth muscle.',
      parasympathetic:
        'Parasympathetic peripheral outflow travels mainly with cranial nerves III, VII, IX and X and pelvic splanchnic nerves S2-S4; limb nerves do not carry a general parasympathetic supply.',
      somaticOrSensory:
        'Somatic motor axons arise from anterior horn cells and somatic sensory axons have cell bodies in dorsal-root ganglia; mixed peripheral nerves contain motor, sensory and sympathetic fibers.',
      referredPain:
        'Radicular pain follows nerve roots/dermatomes, while peripheral mononeuropathy follows the named nerve territory. Distinguishing the two is a core localization step.',
    },
    nerveNodes: [
      {
        id: 'vagus_nerve',
        name: 'Vagus Nerve (CN X)',
        roots: 'Cranial nerve X; motor nuclei and dorsal motor nucleus in medulla',
        origin: 'Medulla; exits skull through jugular foramen and descends within the carotid sheath',
        motorSupply: 'Branchial motor to palate, pharynx and larynx through pharyngeal and laryngeal branches',
        sensorySupply: 'Visceral afferents from thoracic/abdominal viscera; laryngeal sensation; small external-ear territory',
        clinicalNote: 'Recurrent laryngeal nerve injury causes hoarseness/vocal-cord palsy; bilateral high vagal injury can compromise swallowing and airway protection.',
        cameraPreset: 'thorax',
      },
      {
        id: 'phrenic_nerve',
        name: 'Phrenic Nerve',
        roots: 'C3-C5, predominantly C4',
        origin: 'Cervical plexus; descends on anterior scalene into thorax',
        motorSupply: 'Diaphragm',
        sensorySupply: 'Central diaphragmatic pleura/peritoneum, fibrous pericardium and mediastinal pleura',
        clinicalNote: 'Injury causes ipsilateral hemidiaphragm weakness/elevation; diaphragmatic irritation may refer pain to the C3-C5 shoulder region.',
        cameraPreset: 'thorax',
      },
      {
        id: 'brachial_plexus',
        ...
        origin: 'Roots → trunks → divisions → cords → terminal branches from neck to axilla',
        motorSupply: 'Motor supply to shoulder girdle and upper limb through terminal branches',
        sensorySupply: 'Most cutaneous sensation of the upper limb through its terminal branches',
        clinicalNote: 'Upper-trunk C5-C6 lesions produce Erb pattern; lower-trunk C8-T1 lesions produce Klumpke pattern and may be associated with Horner syndrome.',
      ...
      },
      {
        ...
        name: 'Axillary Nerve',
        roots: 'C5-C6',
        origin: 'Posterior cord of brachial plexus; traverses quadrangular space with posterior circumflex humeral artery',
        motorSupply: 'Deltoid and teres minor',
        sensorySupply: 'Superior lateral cutaneous nerve of arm — regimental-badge area',
        clinicalNote: 'At risk in surgical-neck humeral fracture and anterior shoulder dislocation; causes weak abduction from ~15-90° and deltoid wasting.',
        cameraPreset: 'anterior',
      },
      {
        id: 'musculocutaneous_nerve',
        name: 'Musculocutaneous Nerve',
        roots: 'C5-C7',
        origin: 'Lateral cord; pierces coracobrachialis and continues as lateral cutaneous nerve of forearm',
        motorSupply: 'Coracobrachialis, biceps brachii and brachialis',
        sensorySupply: 'Lateral forearm',
        clinicalNote: 'Lesion weakens elbow flexion and forearm supination and reduces the biceps reflex.',
        cameraPreset: 'anterior',
      },
      {
        id: 'radial_nerve',
        name: 'Radial Nerve',
        roots: 'C5-T1',
        origin: 'Posterior cord; passes through triangular interval and radial groove, then divides near lateral epicondyle',
        motorSupply: 'Extensor compartments of arm and forearm; triceps and wrist/finger extensors',
        sensorySupply: 'Posterior arm/forearm and dorsolateral hand via cutaneous branches',
        clinicalNote: 'Radial-groove injury classically causes wrist drop with variable sensory loss over the dorsal first web space.',
        cameraPreset: 'anterior',
      },
      {
        id: 'median_nerve',
        name: 'Median Nerve',
        roots: 'C6-T1, often with C5 contribution',
        origin: 'Lateral and medial cords; descends with brachial artery and enters hand through carpal tunnel',
        motorSupply: 'Most forearm flexor-pronators, thenar muscles via recurrent branch, and lateral two lumbricals',
        sensorySupply: 'Palmar lateral 3½ digits and their nail beds/distal dorsal phalanges',
        clinicalNote: 'Compression in carpal tunnel causes nocturnal paresthesia and thenar weakness; proximal injury may produce hand-of-benediction on attempted fist closure.',
        cameraPreset: 'anterior',
      },
      {
        id: 'ulnar_nerve',
        name: 'Ulnar Nerve',
        roots: 'C8-T1, sometimes C7 contribution',
        origin: 'Medial cord; passes behind medial epicondyle and enters hand superficial to flexor retinaculum through Guyon canal',
        motorSupply: 'FCU, medial FDP and most intrinsic hand muscles',
        sensorySupply: 'Medial 1½ digits and adjacent palmar/dorsal hand',
        clinicalNote: 'Injury at medial epicondyle or Guyon canal can produce interosseous weakness, positive Froment sign and ulnar clawing.',
        cameraPreset: 'anterior',
      },
      {
        id: 'intercostal_nerves',
        name: 'Intercostal Nerves',
        roots: 'T1-T11 anterior rami; T12 continues as subcostal nerve',
        origin: 'Thoracic spinal nerves running in the costal groove between internal and innermost intercostal muscles',
        motorSupply: 'Intercostal and abdominal-wall muscles',
        sensorySupply: 'Thoracic/upper abdominal skin plus parietal pleura and peripheral diaphragmatic peritoneum',
        clinicalNote: 'Chest drains and needle procedures are placed just superior to a rib to reduce injury to the main VAN bundle in the costal groove.',
        cameraPreset: 'thorax',
      },
      {
        id: 'splanchnic_nerves',
        name: 'Thoracic Splanchnic Nerves',
        roots: 'Greater T5-T9; lesser T10-T11; least T12',
        origin: 'Thoracic sympathetic trunk; preganglionic fibers descend to prevertebral ganglia',
        motorSupply: 'Sympathetic autonomic supply to abdominal viscera via prevertebral plexuses',
        sensorySupply: 'Carry visceral pain afferents back toward thoracic spinal segments',
        clinicalNote: 'Celiac plexus/splanchnic interventions may be used for severe upper-abdominal visceral pain, especially pancreatic malignancy.',
        cameraPreset: 'abdomen',
      },
      {
        id: 'femoral_nerve',
        ...
        origin: 'Lumbar plexus; emerges lateral to psoas, passes beneath inguinal ligament into femoral triangle',
        motorSupply: 'Iliacus, sartorius and quadriceps; contributes to pectineus',
        sensorySupply: 'Anterior thigh and medial leg/foot through saphenous nerve',
        clinicalNote: 'Lesion causes weak knee extension, reduced patellar reflex and sensory loss over anterior thigh/medial leg.',
        cameraPreset: 'anterior',
      },
      {
        id: 'obturator_nerve',
        ...
        origin: 'Lumbar plexus; emerges medial to psoas and passes through obturator canal',
        motorSupply: 'Thigh adductors (except hamstring part of adductor magnus) and obturator externus',
        sensorySupply: 'Small variable medial-thigh territory and articular branches to hip/knee',
        clinicalNote: 'Pelvic surgery or obturator injury can cause weak thigh adduction and medial-thigh pain.',
        cameraPreset: 'anterior',
      },
      {
        id: 'sciatic_nerve',
        name: 'Sciatic Nerve',
        roots: 'L4-S3',
        origin: 'Sacral plexus; exits greater sciatic foramen below piriformis and descends in posterior thigh',
        motorSupply: 'Hamstrings and hamstring part of adductor magnus; all leg/foot muscles through tibial and common fibular divisions',
        sensorySupply: 'No direct major cutaneous field in thigh; terminal branches supply most leg/foot sensation',
        clinicalNote: 'Sciatica commonly reflects lumbosacral root irritation; injections are placed in the safe gluteal region to avoid direct sciatic injury.',
        cameraPreset: 'anterior',
      },
      {
        id: 'tibial_nerve',
        name: 'Tibial Nerve',
        roots: 'L4-S3',
        origin: 'Tibial division of sciatic nerve; traverses popliteal fossa and posterior leg, then tarsal tunnel',
        motorSupply: 'Posterior compartment of leg and intrinsic plantar muscles through terminal plantar nerves',
        sensorySupply: 'Heel and plantar foot through calcaneal and plantar branches',
        clinicalNote: 'Tarsal-tunnel compression causes plantar paresthesia; proximal lesion weakens plantarflexion and toe flexion.',
        cameraPreset: 'anterior',
      },
      {
        id: 'common_fibular_nerve',
        name: 'Common Fibular (Peroneal) Nerve',
        roots: 'L4-S2',
        origin: 'Common fibular division of sciatic nerve; winds around fibular neck before dividing',
        motorSupply: 'Anterior/lateral leg through deep and superficial fibular branches',
        sensorySupply: 'Anterolateral leg and most dorsum of foot through terminal branches',
        clinicalNote: 'Fibular-neck injury classically causes foot drop with weak dorsiflexion/eversion and sensory loss over dorsum of foot.',
        cameraPreset: 'anterior',
      },
    ],
    lymphaticDrainage: [
      'Peripheral nerves have no organ-specific lymphatic drainage pattern used for bedside localization; surrounding epineurial/connective tissues drain with regional soft tissues.',
    ],
    musculoskeletalRelations: [
      'Nerves often accompany arteries in neurovascular bundles but can cross compartments at predictable tunnels, foramina and fascial planes.',
      'Common entrapment sites include carpal tunnel (median), cubital tunnel (ulnar), fibular neck (common fibular) and tarsal tunnel (tibial).',
      'Plexuses lie close to bony landmarks used for regional anesthesia and neurologic localization.',
    ],
    relationsStructured: {
      anterior: ['Regional fascia and superficial neurovascular structures'],
      posterior: ['Bones, intermuscular septa and deep fascial planes vary by nerve'],
      superior: ['Spinal roots / plexus of origin'],
      inferior: ['Terminal motor and sensory branches'],
      medial: ['Adjacent named vessels and muscles'],
      lateral: ['Adjacent named vessels and muscles'],
    },
    histologyAndPhysiology:
      'Peripheral nerves contain myelinated and unmyelinated axons grouped into fascicles. Endoneurium surrounds individual axons, perineurium forms the blood-nerve barrier around fascicles, and epineurium encloses the nerve. Schwann cells myelinate peripheral axons and support Wallerian degeneration/regeneration after injury.',
    clinicalBedsideSigns: [
      'Localize weakness by testing muscles supplied by different nerves and roots rather than relying on one movement.',
      'Map light-touch/pinprick loss and compare a named peripheral-nerve territory with a dermatome.',
      'Check relevant deep tendon reflexes: biceps C5-C6, triceps C7-C8, patellar L3-L4, Achilles S1.',
      'Tinel sign can reproduce paresthesia when tapping over an irritated superficial nerve at an entrapment site.',
    ],
    nmcMbbssVivaPearls: [
      'Q: Root value of phrenic nerve? A: C3-C5, mainly C4 — “C3, 4, 5 keep the diaphragm alive.”',
      'Q: Roots of brachial plexus? A: Ventral rami of C5-T1.',
      'Q: Nerve endangered at surgical neck of humerus? A: Axillary nerve with posterior circumflex humeral vessels.',
      'Q: Nerve in carpal tunnel? A: Median nerve.',
      'Q: Nerve behind medial epicondyle? A: Ulnar nerve.',
      'Q: Nerve at fibular neck and classic deficit? A: Common fibular nerve; foot drop.',
      'Q: Root value of sciatic nerve? A: L4-S3.',
    ],
    radiologicalCorrelation:
      'High-resolution ultrasound can show superficial peripheral nerves as fascicular structures and guide blocks/injections. MR neurography can demonstrate nerve enlargement, signal change, denervation edema and mass lesions along deeper nerve pathways.',
    surgicalApproaches:
      'Peripheral nerves are approached using regional anatomy and safe internervous/intermuscular planes. Repair principles include atraumatic handling, debridement of nonviable ends when required, tension-free fascicular/epineurial approximation, and grafting when a gap prevents direct repair.',
    breadcrumbs: [
      { id: 'nervous', label: 'Nervous System' },
      { id: 'peripheral_nerves', label: 'Peripheral Nerves & Plexuses' },
    ],
  },

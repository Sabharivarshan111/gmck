...
export const ORGAN_ANATOMY_DATABASE: Record<string, DetailedOrganAnatomy> = {
  ...
  ureter: {
    ...
    venousDrainage: ['Veins generally parallel arterial sources to renal, gonadal, iliac and vesical veins.'],
  ...
  spinal_cord: {
    ...
    arterialSupply: ['One anterior spinal artery and paired posterior spinal arteries reinforced by segmental medullary vessels including artery of Adamkiewicz.'],
  ...
  pelvis: {
    ...
    venousDrainage: ['Venous drainage follows pelvic arterial territories into iliac venous plexuses.'],
  ...
  skin: {
    ...
    arterialSupply: ['Cutaneous perforators form deep and superficial vascular plexuses with marked regional variation.'],
  ...
  ovary: {
    ...
    venousDrainage: ['Right ovarian vein to IVC; left ovarian vein to left renal vein.'],
  ...
  placenta: {
    ...
    arterialSupply: ['Maternal spiral arteries supply intervillous space; two umbilical arteries carry fetal blood to placenta.'],

...
export const SCENARIOS: ExtendedScenarioDefinition[] = [
  ...
  // 10. NEW EXPANDED CRITICAL CARE & SURGICAL EMERGENCIES
  {
    id: 'massive_pe',
    title: 'Massive Pulmonary Embolism with Acute Cor Pulmonale',
    subtitle: 'Obstructive shock, S1Q3T3 pattern, severe RV strain & acute right heart failure',
    category: 'Cardiovascular & Critical Care',
    departmentId: 'cardiology',
    chiefComplaint: 'Sudden onset pleuritic chest pain, severe air hunger, presyncope, and acute cyanosis',
    history: '48yo female 10 days post total hip arthroplasty with left calf swelling. Refractory hypoxemia despite non-rebreather mask, elevated JVP, clear lungs, systemic hypotension.',
    targetInterventions: ['thrombolysis', 'heparin', 'oxygen', 'norepinephrine'],
    lethalTriggers: ['excess_fluid', 'beta_blocker'],
    initialVitals: {
      heartRate: 134,
      bpSystolic: 76,
      bpDiastolic: 46,
    ...
    initialPathology: {
      ...
      diaphoresis: 0.90,
      ascites: 0.0,
      myocardialIschemia: 0.75,
      pupilLeft: 3.5,
      pupilRight: 3.5,
      pupilReactLeft: true,
      pupilReactRight: true,
      heartSoundType: 's4_gallop',
      lungSoundType: 'vesicular',
      ecgRhythm: 'sinus',
    },
  },
  {
    ...
    title: 'Acute Superior Mesenteric Artery (SMA) Embolism',
    subtitle: 'Severe periumbilical pain out of proportion to exam, lactic acidosis & bowel ischemia',
    category: 'General & Vascular Surgery',
    departmentId: 'surgery',
    chiefComplaint: 'Agonizing periumbilical abdominal pain with vomiting, yet abdomen is completely soft',
    history: '68yo female with chronic atrial fibrillation who ceased anticoagulation. Pain markedly out of proportion to physical exam findings. High anion-gap metabolic acidosis with rising lactate.',
    targetInterventions: ['embolectomy', 'heparin', 'fluids', 'broad_spectrum_antibiotics'],
    lethalTriggers: ['vasopressors_without_flow', 'delay_to_theatre'],
    initialVitals: {
      heartRate: 118,
      bpSystolic: 104,
      bpDiastolic: 64,
  ...
  {
    id: 'ruptured_aaa',
    title: 'Ruptured Infrarenal Abdominal Aortic Aneurysm (AAA)',
    subtitle: 'Classic triad: sudden flank/abdominal pain, pulsatile mass, hemorrhagic shock',
    category: 'Vascular & Emergency Surgery',
    departmentId: 'surgery',
    chiefComplaint: 'Sudden tearing lower back pain radiating into groin followed by syncope',
    history: '72yo male smoker with known 5.8cm abdominal aortic aneurysm. Pale, clammy, profound hypotension, tender pulsatile mass in epigastrium with absent lower extremity pulses.',
    targetInterventions: ['massive_transfusion', 'cross_clamp', 'evari_stent', 'permissive_hypotension'],
    lethalTriggers: ['aggressive_crystalloid_hypertension', 'nitrates'],
    initialVitals: {
      heartRate: 138,
      bpSystolic: 68,
      bpDiastolic: 38,
  ...
  },
  {
    ...
    title: 'Aneurysmal Subarachnoid Hemorrhage (Hunt & Hess Grade IV)',
    subtitle: 'Thunderclap headache, neck stiffness, neurogenic stunned myocardium & blown pupil',
    category: 'Neurology & Neurocritical Care',
    departmentId: 'neurology',
    chiefComplaint: "'Worst headache of my life' followed by collapse and generalized tonic-clonic seizure",
    history: '45yo female with sudden explosive occipital cephalalgia during physical exertion. Stuporous, profound nuchal rigidity, right pupil 6.0mm non-reactive (uncal herniation threat).',
    targetInterventions: ['nimodipine', 'eph_coiling', 'hypertonic_saline', 'seizure_prophylaxis'],
    lethalTriggers: ['acute_hypotension', 'lumbar_puncture_prior_to_ct'],
    initialVitals: {
      heartRate: 54,
      bpSystolic: 196,
      bpDiastolic: 112,
  ...
  {
    id: 'pediatric_epiglottitis',
    title: 'Acute Pediatric Epiglottitis (Haemophilus influenzae type B)',
    subtitle: 'Tripod posture, drooling, high fever & life-threatening inspiratory stridor',
    category: 'Pediatric Critical Care',
    departmentId: 'pediatrics',
    chiefComplaint: '4-year-old child sitting forward in tripod position, drooling, unable to swallow saliva',
    history: 'Rapid onset high fever (39.8°C), muffled voice, severe inspiratory stridor, marked suprasternal and subcostal retractions. High risk of immediate total airway closure.',
    targetInterventions: ['controlled_operating_room_intubation', 'ceftriaxone', 'humidified_oxygen', 'corticosteroids'],
    lethalTriggers: ['tongue_depressor_oral_exam', 'forced_supine_position'],
    initialVitals: {
      heartRate: 165,
      bpSystolic: 86,
      bpDiastolic: 52,
  ...
  {
    id: 'myasthenia_crisis',
    title: 'Myasthenic Crisis with Respiratory Muscle Exhaustion',
    subtitle: 'Diaphragmatic fatigue, paradoxical abdominal breathing & hypercapnic respiratory failure',
    category: 'Neurology & Critical Care',
    departmentId: 'neurology',
    chiefComplaint: 'Severe generalized flaccid weakness, inability to count past 10 in a single breath',
    history: '29yo female with generalized myasthenia gravis complicated by aspiration pneumonia. Rapid shallow breathing with paradoxical inward abdominal motion during inspiration. FVC < 15 mL/kg.',
    targetInterventions: ['plasma_exchange_plasmapheresis', 'ivig', 'non_invasive_ventilation', 'hold_acetylcholinesterase_inhibitors'],
    lethalTriggers: ['neuromuscular_blockers', 'aminoglycosides', 'macrolides'],
    initialVitals: {
      heartRate: 112,
      bpSystolic: 146,
      bpDiastolic: 88,
      meanArterialPressure: 107,
      spo2: 83,
      respiratoryRate: 38,
      temperature: 37.8,
      cvp: 5.5,
